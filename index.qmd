...
- `revdepcheck`: can't use binary repos for Linux, cloud check is private feature
- `revdepcheck.extras`: workflow and CLI improvements but similar limitations
...
![](images/janky.png){fig-align="center" width="45%"}
