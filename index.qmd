...
# The problem {background-color="#385898"}
...
Philosophy: invest developer time to save user time.

All packages should always work together out of the box.

# Background {background-color="#385898"}

## The process

Find all reverse dependencies for your package.

Run `R CMD check` on each one, twice:
...
# Scale challenges {background-color="#385898"}
...
# Solution: revdeprun {background-color="#385898"}
...
Installing 4,395 packages from source would take days.
...
The speedrun used P3M. Setup took 2 hours instead of 20+.
...
# Validation: data.table {background-color="#385898"}
...
# Lessons learned {background-color="#385898"}
...
Adding cloud-scale automation is the next step.
...
Can we optimize the 2+ hour setup phase?
...
# Questions? {background-color="#385898"}
